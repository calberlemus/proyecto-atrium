...
public class FormAltaAdminCompannia extends ValidatorForm {
    ...
    public ActionErrors validate(ActionMapping mapping,
        ...
        /*
         * Si el numRegistro es 0 se muestra un error de campo obligatorio
         * Si el numRegistro existe se muestra un error de numRegistro duplicado
         */
         ...
         * Si existe un dni entre los Administradores de Compaï¿½ï¿½a se muestra un error de dni duplicado		 
         */
        if (this.dni == null || "".equals(this.dni)) {
            errors.add("dni", new ActionMessage(
                    "errors.required", "dni"));
        } else if (gestionU.consultarAdminCompanniasDni(this.dni) != null) {
            errors.add("dni", new ActionMessage(
        ...
        /*
         * Si la poblaciï¿½n está vacía se muetra un error de campo obligatorio		 
         */
         ...
         * Si la fecha de nacimiente es igual o posterior al dï¿½a de hoy se muestra un error
         ...
         * Si el email ya existe entre los Administradores de compannia se muestra
         * un error de email duplicado		 
         */
        if (this.email == null || "".equals(this.email)) {
            errors.add("email", new ActionMessage(
                    "errors.required", "Email"));
        } else if (gestionU.consultarAdminCompanniasEmail(this.email) != null) {
            errors.add("email", new ActionMessage(
