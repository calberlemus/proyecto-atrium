...
public class FormAltaCliente extends ValidatorForm {
	...
	public ActionErrors validate(ActionMapping mapping,
		...
		if (this.numCliente == 0) {
			errors.add("numCliente", new ActionMessage("errors.required", "Número de cliente"));
		} else if (gestionU.consultarClientesNumero(this.numCliente) != null) {
			errors.add("numCliente", new ActionMessage("errors.duplicado", "Número de cliente"));
		}
		
		/*
		 * Si el nick estÃ¡ vacío se muetra un error de campo obligatorio
		...
		/*
		 * Si el pass estÃ¡ vacío se muetra un error de campo obligatorio		 
		 */
