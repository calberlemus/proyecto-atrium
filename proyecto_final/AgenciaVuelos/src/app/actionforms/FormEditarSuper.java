...
public class FormEditarSuper extends ValidatorForm{
  private Long id;
  ...
  @Override
	public ActionErrors validate(ActionMapping mapping,
		 ...
		 * Si el nick existe y no es el del usuario a editar se produce un error de nick duplicado
		 */
		if (this.nick==null || "".equals(this.nick)){
			errors.add("nick", new ActionMessage(
				...
				!(gestionU.consultarUsuario(this.id)).getNick().equals(this.nick)){
			errors.add("nick", new ActionMessage(
		 ...
		 * Si la fecha de nacimiente es igual o posterior al día de hoy se muestra un error
