...
<div class="form-alta-cliente">
	<html:form action="alta-cliente-registro.do">
		<div>Nº de Cliente</div>
		<html:text property="numCliente" size="5" styleClass="num-cliente" />
		...
		<div>Teléfono</div>
		<html:text property="telefono" size="5" />
		<div>Email</div>
