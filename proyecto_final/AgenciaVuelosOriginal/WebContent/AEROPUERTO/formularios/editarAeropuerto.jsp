...
<html:form action="editar-aeropuerto.do">
	...
	<div>Ciudad</div>
	<html:text property="ciudad" size="50" />
...
<html:form action="editar-aeropuerto.do">
	<div>Código</div>
	<html:hidden property="id" value="<%=aeropuerto.getId().toString()%>" />
	<html:text property="codigo" size="50"
		value="<%=aeropuerto.getCodigo()%>" />
	<div>Nombre</div>
	<html:text property="nombre" size="50"
		value="<%=aeropuerto.getNombre()%>" />
	<div>País</div>
	<html:text property="pais" size="50" value="<%=aeropuerto.getPais()%>" />
	<div>Ciudad</div>
	<html:text property="ciudad" size="50"
		value="<%=aeropuerto.getCiudad()%>" />
	<html:submit value="Guardar" />
</html:form>
<%
	}
